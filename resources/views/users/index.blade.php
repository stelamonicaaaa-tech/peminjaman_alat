    ...
    <div class="max-w-7xl mx-auto">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-800 flex items-center gap-3">
                        <div
                            ...
                            <i class='bx bxs-user-account text-white text-xl'></i>
                        </div>
                        Data User
                    </h1>
                    <p class="text-gray-500 text-sm mt-1">Kelola data pengguna sistem</p>
                </div>
                <a href="{{ route('users.create') }}"
                    class="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-5 py-2.5 rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl p-5 text-white shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold mt-1">{{ $allData->where('role', 'admin')->count() }}</h3>
                    </div>
                    <div class="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
            ...
            <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl p-5 text-white shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold mt-1">{{ $allData->where('role', 'petugas')->count() }}</h3>
                    </div>
                    <div class="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
            ...
            <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-5 text-white shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-green-100 text-sm font-medium">Peminjam</p>
                        <h3 class="text-3xl font-bold mt-1">{{ $allData->where('role', 'peminjam')->count() }}</h3>
                    </div>
                    <div class="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="w-10 h-10 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-full flex items-center justify-center text-white font-semibold shadow">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @php
                                        $roleColors = [
                                            ...
                                            'peminjam' => 'bg-green-100 text-green-700 border-green-200',
                                        ];
                                        $colorClass =
                                            $roleColors[$item->role] ?? 'bg-gray-100 text-gray-700 border-gray-200';
                                    @endphp
                                    <span
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <h3 class="text-lg font-semibold text-gray-700 mb-1">Tidak ada data user</h3>
                                        <p class="text-gray-500 text-sm">Silakan tambahkan user baru</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
