            ...
            <div class="lg:col-span-2">
                        ...
                        <h1 class="text-2xl font-bold text-gray-800 flex items-center gap-3">
                            <div class="flex gap-3">
                                <div
                                    ...
                                    <i class='bx bxs-user-detail text-white text-xl'></i>
                                </div>
                ...
                <div class="mb-6 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-5">
                    <div class="flex items-center gap-4">
                        <div
                            class="w-16 h-16 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center text-white font-bold text-2xl shadow-lg">
                        ...
                        <div>
                            ...
                            @endphp
                            <span
                                class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold border {{ $colorClass }} mt-2">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">
                                    ...
                                    Password
                                    <span class="text-xs font-normal text-gray-500">(kosongkan jika tidak diubah)</span>
                                </label>
                                <div class="relative">
                ...
                <div class="bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200 rounded-xl p-5 shadow-sm">
                    ...
                    <ul class="space-y-2 text-sm text-amber-800">
                        <li class="flex items-start gap-2">
                            ...
                            <span>Perubahan data akan langsung tersimpan</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <i class='bx bx-check text-amber-600 text-lg shrink-0'></i>
                            <span>Password hanya diubah jika diisi</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <i class='bx bx-check text-amber-600 text-lg shrink-0'></i>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-blue-800 leading-relaxed">
                                Jika mengubah role user, pastikan user tersebut memahami tanggung jawab role barunya.
                            </p>
                        </div>
                    </div>
                </div>
